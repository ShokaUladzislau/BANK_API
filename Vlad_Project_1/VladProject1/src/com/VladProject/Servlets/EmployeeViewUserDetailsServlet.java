...
@WebServlet("/EmployeeViewUserDetails")
public class EmployeeViewUserDetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/employeeUserDetails.jsp").forward(request, response);
