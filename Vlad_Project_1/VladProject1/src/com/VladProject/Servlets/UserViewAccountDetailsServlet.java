...
@WebServlet("/UserViewAccountDetails")
public class UserViewAccountDetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/userAccountDetails.jsp").forward(request, response);
