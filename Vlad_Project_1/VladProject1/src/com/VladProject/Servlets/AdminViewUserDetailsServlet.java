...
@WebServlet("/AdminViewUserDetails")
public class AdminViewUserDetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/adminUserDetails.jsp").forward(request, response);
